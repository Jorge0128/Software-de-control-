...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2023 a las 21:44:35
...
(2, 'Hoja A4', 500, 1, 6.50, 3, NULL, '2023-08-26 10:44:10', 1);
...
(1, 'KEVIN DANIEL', 'VILCHEZ GIRÒN', '77777777', 1, 'kevin@gmail.com', '123', '2023-07-27 18:10:10', 1),
(3, 'JORGE', 'AVILA GIRON', '76452258', 2, 'jorge@gmail.com', '123', '2023-07-27 20:01:30', 1);
...
--
ALTER TABLE `tcargo`
  MODIFY `idCargo` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
